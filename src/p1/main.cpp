...
#define KEY_TRANSLEFT SDLK_a
#define KEY_TRANSDOWN SDLK_s
#define KEY_TRANSRIGHT SDLK_d
#define KEY_TRANSUP SDLK_w
#define KEY_TRANSNEAR SDLK_q
#define KEY_TRANSFAR SDLK_e
